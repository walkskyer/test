...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[["fullscreen","source","undo","redo","insertorderedlist","insertunorderedlist","link","unlink","pagebreak","insertimage","attachment","map","spechars","bold","italic","underline","strikethrough","forecolor","backcolor","justifyleft","justifycenter","justifyright","justifyjustify","fontfamily"]]
